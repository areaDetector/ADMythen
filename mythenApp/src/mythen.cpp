...
asynStatus mythen::writeReadMeter()
{
    ...
    asynPrint(pasynUserSelf, ASYN_TRACEIO_DRIVER, "%s:%s: sent this string to the driver outString_ = %s, inString_ = %s, status = %d\n",
          driverName, functionName, outString_, inString_, status);
